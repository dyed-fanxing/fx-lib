...
public class TransparencyShards {
    public static RenderStateShard.TransparencyStateShard LINEAR_ADDITIVE_TRANSPARENCY = new RenderStateShard.TransparencyStateShard("linear_additive_transparency", () -> {
