...
public class CapsuleCCDUtils {
     ...
     * 获取碰撞检测实体列表
     */
    public static List<Entity> getHitEntities(Entity entity,Vec3 start,float radius, double length, Predicate<Entity> filter,ClipContext.Block block, ClipContext.Fluid fluid) {
        Level level = entity.level();
