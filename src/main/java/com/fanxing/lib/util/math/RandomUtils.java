...
public final class RandomUtils {
     ...
     */
    public static float around(float avg, float amp) {
     ...
     */
    public static int around(int avg, int amp) {
     ...
     * 若需要约束输出为整数，可在外面取整。
     */
    public static float bipolarAbs(float absAvg, float amp) {
        float half = amp / 2f;
     ...
     * 若需要约束输出为整数，可在外面取整。
     */
    public static int bipolarAbs(int absAvg, int amp) {
        int half = amp / 2;
