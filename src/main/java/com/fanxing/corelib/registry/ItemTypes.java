...
import static com.fanxing.corelib.FxCoreLib.MOD_ID;
...
public class ItemTypes {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("fx_corelib_tab",
            () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.fx_corelib")) // 标签页标题
