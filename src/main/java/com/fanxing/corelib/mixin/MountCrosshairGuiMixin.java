package com.fanxing.corelib.mixin;

import com.fanxing.corelib.FxCoreLib;
import com.fanxing.corelib.entity.capability.Mountable;
...
public abstract class MountCrosshairGuiMixin {
    @Unique
    private static final ResourceLocation MOUNT_CROSSHAIR = ResourceLocation.fromNamespaceAndPath(FxCoreLib.MOD_ID, "hud/mount_crosshair");
