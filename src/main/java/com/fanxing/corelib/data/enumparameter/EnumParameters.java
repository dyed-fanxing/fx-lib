package com.fanxing.corelib.data.enumparameter;


import com.fanxing.corelib.FxCoreLib;
import com.fanxing.corelib.data.damagesource.CustomNounVerbDeathMessageProvider;
...
public class EnumParameters {
    ...
    public static final EnumProxy<DamageEffects> SILENT = new EnumProxy<>(
            DamageEffects.class,
            FxCoreLib.MOD_ID+":"+"silent",(Supplier<SoundEvent>) () -> null          // 返回 null，表示无音效
    );
    // 自定义名词动词死亡消息类型
    public static final EnumProxy<DeathMessageType> CUSTOM_NOUN_VERB_DEATH = new EnumProxy<>(
            DeathMessageType.class,
            FxCoreLib.MOD_ID+":"+"custom_noun_verb_death",new CustomNounVerbDeathMessageProvider()
    );
